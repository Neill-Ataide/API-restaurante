...
import uea.restaurante.services.RefeicaoServices;
...
public class RefeicaoResources {
	...
	@Autowired
	private RefeicaoServices refeicaoServices;

	@PostMapping
	public ResponseEntity<Refeicao> criar(@RequestBody Refeicao refeicao) {
		Refeicao refeicaoSalva = refeicaoServices.criar(refeicao);
